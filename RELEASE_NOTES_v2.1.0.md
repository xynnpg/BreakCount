...
**Version code:** 5
**Track:** Production (Google Play graduation from Early Access)

---

## What's New (Play Store short — 500 chars)

BreakCount levels up! 🎉 10+ themes (unlock more with daily streaks), 30 unique personas with custom copy, 100+ achievements with XP/levels and daily quests, real stats charts, offline timetable OCR, lock-screen countdown (Android 14+), break-reveal confetti, shareable achievement cards, peer achievement compare, and a cleaner counter tab. Built by a student, for students.
...
### 🎨 Themes
- 6 default themes: Coffee, Midnight, Mint, Sakura, Ocean, Sunset
- 11 unlockable themes gated by daily streak milestones (7/14/30/50/75/100/150/200/365 days) and achievement triggers
- Home-screen widgets now follow the active theme + persona tint colors
...
- New personas: Nerd 🤓, Tired 🥱, Ice 🧊, Gremlin 😈, Philosopher 🧐, Goblin 👺, Cloud ☁️, Volcano 🌋, Sloth 🦥, Storm ⛈️, Sprout 🌱, Moon 🌙, Star ⭐, Phoenix 🦅, Sunflower 🌻, Jester 🃏, Monk ☸️, Rebel 🤘, Hacker 💻, Chef 👨‍🍳, Pirate 🏴‍☠️, Robot 🤖
...
- Daily quests: 3 bite-size tasks that refresh at midnight, granting XP on completion
- Rarity-sorted gallery with filter chips, search, and detail sheets
- Shareable achievement cards (1080×1920 PNG)
- Peer achievement compare over Nearby Connections

### 📊 Stats Deep-Dive
- Weekly scheduled hours bar chart (from timetable)
- Subject distribution pie chart
- Mood distribution (7d/30d toggle)
- Achievement unlock pace line chart
- Manual study log with FAB ("I studied...") — tracks sessions per subject

### 🤖 Offline OCR
- New offline pre-pass using ML Kit text recognition before calling Groq/Gemini
- Saves API quota on clear printed timetables
- Green "Parsed offline — no API call used" banner in review screen

### 📱 Lock-Screen Countdown (Android 14+)
- Optional foreground service showing persistent break countdown on lock screen
- Chronometer-based live tick, refreshes every 15 minutes
- Toggle in Settings → Notifications

### ✨ UI Improvements
- Counter tab restructured: Vibe and Achievements moved to dedicated full-view screens accessible via header icons (✨ and 🏆)
- Break-reveal confetti animation on first app-open after a break starts
- Dedicated Vibe screen with persona gallery, mood calendar, beacon CTA, recap history
- Dedicated Achievements screen with XP header, quests row, rarity grid, detail sheets
...
- Unlock service for theme/persona gating
...
3. [ ] Fill release notes (copy "What's New" section above)
